"""
CS241 Team Activity 05 - Stretch
...
### If using pycharm, then need to install arcade package
### in the virtual envrionment.  Goto File | Settings | Project | Project Interpreter | Add
import arcade

SCREEN_WIDTH = 500
SCREEN_HEIGHT = 600
BALL_RADIUS = 40 # Updated from 20
...
class MyGame(arcade.Window):
    ...
    def on_draw(self):
        ...
        arcade.draw_circle_filled(self.ball_x_position, SCREEN_HEIGHT // 2,
                                  BALL_RADIUS, arcade.color.RED)  # Updated from Green
